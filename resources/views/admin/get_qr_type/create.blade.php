    ...
    <div class="card-body">
      ...
      <form class="forms-sample" method="POST" action="{{$url}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="exampleInputUsername1" name="qr_name" value="{{ old('qr_name') }}">
        </div>

        <div class="form-group">
          <br />
          <label for="exampleInputUsername1">อัพโหลดรูป <span class="text-danger">*</span></label>
