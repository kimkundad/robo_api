...
<div class="col-md-12">
  <div class="card">
    <div class="card-body">
      <h4 class="card-title">ข้อมูล {{ $objs->name_bank }}</h4>
      ...
      <form class="forms-sample" method="POST" action="{{$url}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control"  name="name_bank" value="{{ $objs->name_bank }}">
        </div>
        ...
        <div class="form-group">
          ...
          <br />
          <img src="{{ url('img/bank/'.$objs->bank_img) }}" style="width: 250px; border: 2px solid #439aff;" >
          <br />
          <br />
