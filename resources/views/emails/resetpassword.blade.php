										...
										<tr>
											<td height="25" valign="middle" align="center">
												...
												<table  align="center" cellspacing="0" cellpadding="0" border="0" class="full-width">
													<tbody>
														<tr>
															 <td align="center"><img src="https://www.robotel.co.th/img/PromptRUB%20Original.png"  height="100"/></td>
																		...
																		<td align="center">
																			...
																			<table width="100%" align="center" cellspacing="0" cellpadding="0" border="0" class="full-width" >
																				<tbody>
                                                                                    ...
                                                                                    <tr>
																						<td><img src="https://www.robotel.co.th/img/about/promptRUB-Web-Vector-2@2x.png"  style="width:100%; height:auto" /></td>
																					</tr>
																					...
																					<tr >
																						<td style="font-size:14px; mso-line-height-rule:exactly; line-height:18px; color:#666; font-weight:normal; font-family: Arial, Helvetica, sans-serif;" align="left">
                                                                                        คุณได้รับอีเมลฉบับนี้เนื่องจากเราได้รับคำขอรีเซ็ตรหัสผ่านสำหรับบัญชีของคุณ </td>
																					</tr>
																					<tr>
                                                                                    ...
                                                                                    <tr >
																						<td style="font-size:14px; mso-line-height-rule:exactly; line-height:18px; color:#666; font-weight:normal; font-family: Arial, Helvetica, sans-serif;" align="left">
                                                                                        ลิงก์รีเซ็ตรหัสผ่านนี้จะหมดอายุใน 60 นาที <br>
                                                                                        หากคุณไม่ได้ขอรีเซ็ตรหัสผ่านก็ไม่จำเป็นต้องดำเนินการใด ๆ เพิ่มเติม</td>
																					</tr>
																					<tr >
																						<td style="font-size:12px; mso-line-height-rule:exactly; line-height:18px; color:#95a5a6; font-weight:normal; font-family: Arial, Helvetica, sans-serif;" align="left">
																							<hr />
																							หากคุณประสบปัญหาในการคลิกปุ่ม "รีเซ็ตรหัสผ่าน" ให้คัดลอกและวาง URL ด้านล่างลงในเว็บเบราว์เซอร์ของคุณ <a href="{{$url}}">{{$url}}</a>.</td>
																					</tr>
                                                                                    <tr>
																						<td height="30">&nbsp;</td>
																					</tr>
																...
																<tbody>
																	<tr>
																		<td  align="center" valign="middle" style="font-family: Arial, Helvetica, sans-serif;font-size:11px; font-weight:normal; color:#cccccc; padding-top:10px; padding-bottom:10px">
																			<strong>Copyright © 2020 robotel.co.th</strong><br />
																		</td>
																	</tr>
																</tbody>
															</table>
